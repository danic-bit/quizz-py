...
def shuffle_alt(pregunta):
    ...
    random.shuffle(pregunta["alternativas"])  #se toma la lista y se desordenan aleatoriamente sus elementos
...
if __name__ == '__main__':
    ...
    #ejemplo2
    #print(shuffle_alt(p.pool_preguntas['avanzadas']['pregunta_3'])) 